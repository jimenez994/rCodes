                ...
                <c:forEach items="${posts}" var="post">
                    <div class="card mb-2 text-top">
                        ...
                        <small class="text-muted ml-2"> 5 Like * <a href="#collapseComments${post.getId()}"
                                ...
                                class="text-muted">${post.getComments().size()} Comment </a></small>
                        <!-- comments list -->
                        <div id="collapseComments${post.getId()}" class="collapse">
                            <c:forEach items="${post.comments}" var="comment">
                                <div class="d-flex row-hl ml-2">
                                    <img id="userImgComment"
                                        src="/images/${comment.getUser().getUserInfo().getProfileImg()}"
                                        alt="${cUser.getUserInfo().getProfileImg()}"
                                        class="img-fluid item-hl mt-1 rounded-circle mt-2 ml-2">
                                    <div class="item-hl ml-2 mt-1">
                                        <small class="mr-2"> <a class="text-dark"
                                                href="/profile/${comment.getUser().getId()}">
                                                <strong>${comment.getUser().getUserInfo().getFirstName()}</strong> </a>
                                        </small><br>
                                        <small> <a class="text-muted" href="/profile/${comment.getUser().getId()}">
                                                ${comment.getUser().getUserInfo().getHeadline()} </a></small>
                                    </div>
                        ...
                        <div class="card-footer text-muted">
                            <small class="mr-2"><a href="#" class="text-secondary"><i class="fa fa-thumbs-o-up"></i>
                                    like </a></small>
                            <small class="mr-2"> <a href="#collapseCommentForm${post.getId()}" data-toggle="collapse"
                                    data-parent="#accordion" aria-expanded="true" class="text-secondary"> <i
                                        class="fa fa-comment-o"></i> comment </a></small>
